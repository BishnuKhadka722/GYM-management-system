...
if(isset($_SESSION['payment_successful']) && isset($_SESSION['payment_data'])) {
    // Set POST data from session for compatibility with existing code
    $_POST = $_SESSION['payment_data'];
    
    // Clear session data to prevent duplicate processing
